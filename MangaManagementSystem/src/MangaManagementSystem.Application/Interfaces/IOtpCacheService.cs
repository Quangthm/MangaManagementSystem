...
public interface IOtpCacheService
{
    ...
    bool TryValidateAndRemoveProfileActionOtp(string email, string actionCode, string otp);    public interface IOtpCacheService
    {
        void StoreRegistrationOtp(
            string email,
            string otp,
            RegisterDto request);

        RegisterDto? TryValidateAndRemoveRegistrationOtp(
            string email,
            string otp);

        void StoreProfileActionOtp(
            string email,
            string actionCode,
            string otp);

        bool TryValidateAndRemoveProfileActionOtp(
            string email,
            string actionCode,
            string otp);
    }
