        ...
        public void Configure(EntityTypeBuilder<FileResource> builder)
        {
            builder.ToTable("FileResource", "manga", t =>
            {
                t.HasCheckConstraint(
                    "CK_FileResource_PurposeCode",
                    "file_purpose_code IN ('SERIES_PROPOSAL','SERIES_COVER','CHAPTER_DRAFT','CHAPTER_ASSET','CHAPTER_PAGE_VERSION','TASK_REFERENCE','TASK_SUBMISSION','EDITORIAL_ATTACHMENT','REGISTRATION_PORTFOLIO','USER_AVATAR')");
            });
