...
namespace MangaManagementSystem.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // Only register Cloudinary services when real credentials are provided.
            // This prevents API startup from crashing when appsettings.json contains empty or placeholder values.
