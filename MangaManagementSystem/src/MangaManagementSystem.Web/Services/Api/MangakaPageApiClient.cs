...
namespace MangaManagementSystem.Web.Services.Api
{
    public class MangakaPageApiClient : IMangakaPageApiClient
    {
        ...
        public async Task<IReadOnlyList<ChapterPageDto>> GetByChapterAsync(Guid chapterId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ChapterPageDto?> GetByIdAsync(Guid pageId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IReadOnlyDictionary<Guid, int>> GetCountsAsync(IReadOnlyList<Guid> chapterIds, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ChapterPageDto?> UpdateNotesAsync(Guid pageId, string? pageNotes, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<CreatePageWithVersionResponseDto?> CreatePageWithVersionAsync(CreatePageWithVersionRequestDto requestBody, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IReadOnlyList<ChapterPageVersionDto>> GetVersionsByPageIdsAsync(IReadOnlyList<Guid> pageIds, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ChapterPageVersionDto?> GetVersionByIdAsync(Guid versionId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ChapterPageVersionDto?> CreateVersionWithFileAndRegionsAsync(CreateVersionWithFileAndRegionsRequestDto requestBody, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ChapterPageVersionDto?> UpdateVersionAsync(UpdateChapterPageVersionDto requestBody, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<bool> SetCurrentVersionAsync(Guid pageId, Guid versionId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<DeleteVersionImageResultDto?> DeleteVersionImageAsync(Guid versionId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IReadOnlyList<FileResourceDto>> GetFileResourcesByIdsAsync(IReadOnlyList<Guid> fileIds, CancellationToken cancellationToken = default)
        {
