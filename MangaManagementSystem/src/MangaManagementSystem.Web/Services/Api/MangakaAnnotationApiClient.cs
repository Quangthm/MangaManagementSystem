...
namespace MangaManagementSystem.Web.Services.Api
{
    public class MangakaAnnotationApiClient : IMangakaAnnotationApiClient
    {
        ...
        public async Task<IReadOnlyList<ChapterPageAnnotationDto>> GetByPageAsync(Guid chapterPageId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ChapterPageAnnotationDto> CreateAsync(CreateMangakaAnnotationRequest request, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<bool> ResolveAsync(Guid annotationId, string? resolutionNote = null, CancellationToken cancellationToken = default)
        {
