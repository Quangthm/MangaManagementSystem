...
| US-MANGAKA-008 | BR-CH-001, BR-CH-002, BR-CH-003, BR-CH-006, BR-CH-014, BR-PUB-SCHEDULE-001, BR-PUB-SCHEDULE-004, BR-PUB-SCHEDULE-005, BR-PUB-SCHEDULE-006 | As a Mangaka, I want to create or plan chapters with valid planned release dates according to the series publication frequency, so that active series chapters remain organized and schedulable while cancelled attempts can still be replaced. |
...
| US-MANGAKA-026 | BR-PUB-SCHEDULE-001, BR-PUB-SCHEDULE-002, BR-PUB-SCHEDULE-003, BR-PUB-SCHEDULE-004, BR-PUB-SCHEDULE-005, BR-PUB-SCHEDULE-006, BR-PUB-SCHEDULE-007, BR-PUB-SCHEDULE-008 | As a Mangaka, I want the system to explain valid planned release date ranges for first and later chapters, including weekly, monthly, irregular, and undecided-frequency cases, so that my chapter planning follows the approved publication frequency. |
| US-MANGAKA-027 | BR-CH-016, BR-CH-017, BR-CH-018, BR-PUB-SCHEDULED-001, BR-PUB-SCHEDULED-002, BR-PUB-SCHEDULED-003, BR-PUB-SCHEDULED-004 | As a Mangaka, I want scheduled and on-hold chapters to clearly show why editing is locked and who can reschedule or place the chapter on hold, so that I understand why page workflows are unavailable. |
---
...
| US-EDITOR-010 | BR-CH-REV-006, BR-CH-REV-007, BR-CH-REV-008, BR-CH-REV-010, BR-CH-REV-011, BR-CH-REV-011A, BR-CH-REV-012, BR-CH-REV-013, BR-CH-REV-015 | As a Tantou Editor, I want to record APPROVED, REVISION_REQUESTED, or CANCELLED decisions, with approval moving a chapter to SCHEDULED when a valid planned release date already exists, so that chapter outcomes are clear and enforceable. |
...
| US-EDITOR-012 | BR-CH-010, BR-CH-018, BR-PUB-SCHEDULED-004, BR-PUB-SCHEDULED-005 | As a Tantou Editor, I want to place a scheduled chapter ON_HOLD only when there is a valid editorial or operational reason, so that work can pause without being cancelled while recovery remains a later workflow. |
| US-EDITOR-014 | BR-CH-017, BR-PUB-SCHEDULED-003, BR-PUB-SCHEDULE-001, BR-PUB-SCHEDULE-002, BR-PUB-SCHEDULE-003, BR-PUB-SCHEDULE-004, BR-PUB-SCHEDULE-005, BR-PUB-SCHEDULE-006 | As a Tantou Editor, I want to reschedule a scheduled chapter only within the allowed publication period, so that release planning remains consistent with the official frequency. |
| US-EDITOR-015 | BR-CH-014, BR-CH-015, BR-PUB-001, BR-PUB-SCHEDULED-006 | As a Tantou Editor, I want to set or confirm planned release dates during chapter planning and approval, so that approved chapters with valid planned dates move directly to scheduled status and remain audit-visible. |
