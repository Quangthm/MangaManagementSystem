...
| US-MANGAKA-008 | BR-CH-001, BR-CH-002, BR-CH-003, BR-CH-006 | As a Mangaka, I want to create chapters with chapter labels that are unique among non-cancelled chapters and optional planned release dates, so that active series chapters remain organized while cancelled attempts can be replaced. |
...
| US-MANGAKA-019 | BR-CH-SUB-003, BR-CH-SUB-004, BR-CH-CANCEL-006 | As a Mangaka, I want chapter pages to lock during review, become editable again when revision is requested, and remain read-only when cancelled, so that fixable work can be corrected while cancelled attempts stay preserved. |
...
| US-MANGAKA-023 | BR-PUB-001, BR-PUB-006, BR-PUB-009, BR-PUB-DATE-001, BR-PUB-DATE-002, BR-PUB-DATE-003 | As a Mangaka, I want to view chapter-level release planning, publication business dates, and derived delays, so that I understand the publication schedule for my series. |
...
| US-MANGAKA-026 | BR-PUB-SCHEDULE-001, BR-PUB-SCHEDULE-002, BR-PUB-SCHEDULE-003, BR-PUB-SCHEDULE-004, BR-PUB-SCHEDULE-005, BR-PUB-SCHEDULE-006 | As a Mangaka, I want the system to suggest the next valid planned release date and keep schedule changes inside the required next publication period for weekly or monthly series, so that my chapter planning follows the approved publication frequency. |
---
...
| US-EDITOR-010 | BR-CH-REV-006, BR-CH-REV-007, BR-CH-REV-008, BR-CH-REV-010, BR-CH-REV-011, BR-CH-REV-012, BR-CH-REV-013 | As a Tantou Editor, I want to record APPROVED, REVISION_REQUESTED, or CANCELLED decisions, with non-blank comments required for revision and cancellation and optional markup files for supporting feedback, so that chapter outcomes are clear and enforceable. |
