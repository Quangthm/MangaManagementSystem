...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Also get annotations linked directly to the page
        INSERT INTO @Annotations SELECT chapter_page_annotation_id FROM manga.ChapterPageAnnotation WHERE chapter_page_id IN (SELECT chapter_page_id FROM @Pages)
        AND chapter_page_annotation_id NOT IN (SELECT chapter_page_annotation_id FROM @Annotations);
